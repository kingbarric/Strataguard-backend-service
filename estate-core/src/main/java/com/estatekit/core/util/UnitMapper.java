...
public interface UnitMapper {
    ...
    @Mapping(target = "status", expression = "java(com.estatekit.core.enums.UnitStatus.VACANT)")
    ...
    @Mapping(target = "deleted", ignore = true)
    @Mapping(target = "version", ignore = true)
    void updateEntity(com.estatekit.core.dto.unit.UpdateUnitRequest request, @MappingTarget Unit unit);
}
